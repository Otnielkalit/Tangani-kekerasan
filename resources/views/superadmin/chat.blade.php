@extends('superadmin.beranda_index')
        ...
        <div class="row g-0">
            ...
            <div class="col app-chat-sidebar-left app-sidebar overflow-hidden" id="app-chat-sidebar-left">
                <div
                    ...
                    <div class="avatar avatar-xl avatar-online">
                        <img src="{{ asset('assetschat/img/avatars/1.png') }}" alt="Avatar" class="rounded-circle">
                    </div>
                    ...
                    <div class="d-flex align-items-center me-3 me-lg-0">
                        <div class="flex-shrink-0 avatar avatar-online me-2" data-bs-toggle="sidebar"
                            ...
                            <img class="user-avatar rounded-circle cursor-pointer"
                                src="{{ asset('assetschat/img/avatars/1.png') }}" alt="Avatar">
                        </div>
                ...
                <div class="sidebar-body">
                        ...
                        <li class="chat-contact-list-item">
                            <a class="d-flex align-items-center">
                                <div class="flex-shrink-0 avatar avatar-online">
                                    <img src="{{ asset('assetschat/img/avatars/13.png') }}" alt="Avatar"
                        ...
                        <li class="chat-contact-list-item active">
                            <a class="d-flex align-items-center">
                                <div class="flex-shrink-0 avatar avatar-offline">
                                    <img src="{{ asset('assetschat/img/avatars/2.png') }}" alt="Avatar"
                                        class="rounded-circle">
                                </div>
                                <div class="chat-contact-info flex-grow-1 ms-3">
                        ...
                        <li class="chat-contact-list-item">
                            <a class="d-flex align-items-center">
                                ...
                                <div class="chat-contact-info flex-grow-1 ms-3">
                                    ...
                                    <p class="chat-contact-status text-truncate mb-0 text-muted">If it takes long you can
                                        mail inbox user</p>
                                </div>
                    ...
                    <ul class="list-unstyled chat-contact-list mb-0" id="contact-list">
                        ...
                        <li class="chat-contact-list-item">
                            <a class="d-flex align-items-center">
                                <div class="flex-shrink-0 avatar avatar-offline">
                                    <img src="{{ asset('assetschat/img/avatars/4.png') }}" alt="Avatar"
                                        class="rounded-circle">
                                </div>
                                <div class="chat-contact-info flex-grow-1 ms-3">
                        ...
                        <li class="chat-contact-list-item">
                            <a class="d-flex align-items-center">
                                <div class="flex-shrink-0 avatar avatar-busy">
                                    <img src="{{ asset('assetschat/img/avatars/5.png') }}" alt="Avatar"
                                        class="rounded-circle">
                                </div>
                                <div class="chat-contact-info flex-grow-1 ms-3">
                        ...
                        <li class="chat-contact-list-item">
                            <a class="d-flex align-items-center">
                                <div class="flex-shrink-0 avatar avatar-busy">
                                    <img src="{{ asset('assetschat/img/avatars/7.png') }}" alt="Avatar"
                                        class="rounded-circle">
                                </div>
                                <div class="chat-contact-info flex-grow-1 ms-3">
                        ...
                        <li class="chat-contact-list-item">
                            <a class="d-flex align-items-center">
                                <div class="flex-shrink-0 avatar avatar-offline">
                                    <img src="{{ asset('assetschat/img/avatars/8.png') }}" alt="Avatar"
                                        class="rounded-circle">
                                </div>
                                <div class="chat-contact-info flex-grow-1 ms-3">
                        ...
                        <li class="chat-contact-list-item">
                            <a class="d-flex align-items-center">
                                <div class="flex-shrink-0 avatar avatar-busy">
                                    <img src="{{ asset('assetschat/img/avatars/10.png') }}" alt="Avatar"
                                        class="rounded-circle">
                                </div>
                                <div class="chat-contact-info flex-grow-1 ms-3">
                        ...
                        <li class="chat-contact-list-item">
                            <a class="d-flex align-items-center">
                                <div class="flex-shrink-0 avatar avatar-busy">
                                    <img src="{{ asset('assetschat/img/avatars/11.png') }}" alt="Avatar"
                                        class="rounded-circle">
                                </div>
                                <div class="chat-contact-info flex-grow-1 ms-3">
                                ...
                                <div class="d-flex overflow-hidden">
                                    ...
                                    <div class="user-avatar flex-shrink-0 ms-3">
                                        <div class="avatar avatar-sm">
                                            <img src="{{ asset('assetschat/img/avatars/1.png') }}" alt="Avatar"
                                                class="rounded-circle">
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="col app-chat-sidebar-right app-sidebar overflow-hidden" id="app-chat-sidebar-right">
                <div
                    ...
                    <div class="avatar avatar-xl avatar-online">
                        <img src="{{ asset('assetschat/img/avatars/2.png') }}" alt="Avatar" class="rounded-circle">
                    </div>
...
@section('css')
    ...
    <link rel="icon" type="image/x-icon" href="{{ asset('assetschat/img/favicon/favicon.ico') }}">
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link
        href="https://fonts.googleapis.com/css2?family=Public+Sans:ital,wght@0,300;0,400;0,500;0,600;0,700;1,300;1,400;1,500;1,600;1,700&display=swap"
        rel="stylesheet">
    <link rel="stylesheet" href="{{ asset('assetschat/vendor/fonts/fontawesome.css') }}">
    <link rel="stylesheet" href="{{ asset('assetschat/vendor/fonts/flag-icons.css') }}">
    <link rel="stylesheet" href="{{ asset('assetschat/vendor/css/rtl/core.css') }}"
        class="template-customizer-core-css">
    <link rel="stylesheet" href="{{ asset('assetschat/vendor/css/rtl/theme-default.css') }}"
        class="template-customizer-theme-css">
    <link rel="stylesheet" href="{{ asset('assetschat/css/demo.css') }}">
    <link rel="stylesheet" href="{{ asset('assetschat/vendor/libs/perfect-scrollbar/perfect-scrollbar.css') }}">
    <link rel="stylesheet" href="{{ asset('assetschat/vendor/libs/typeahead-js/typeahead.css') }}">
    <link rel="stylesheet" href="{{ asset('assetschat/vendor/libs/bootstrap-maxlength/bootstrap-maxlength.css') }}">
    <link rel="stylesheet" href="{{ asset('assetschat/vendor/css/pages/app-chat.css') }}">
    <script src="{{ asset('assetschat/vendor/js/helpers.js') }}"></script>
    <script src="{{ asset('assetschat/vendor/js/template-customizer.js') }}"></script>
    <script src="{{ asset('assetschat/js/config.js') }}"></script>
@endsection()
@section('js')
    <script src="{{ asset('assetschat/vendor/libs/jquery/jquery.js') }}"></script>
    <script src="{{ asset('assetschat/vendor/libs/popper/popper.js') }}"></script>
    <script src="{{ asset('assetschat/vendor/js/bootstrap.js') }}"></script>
    <script src="{{ asset('assetschat/vendor/libs/perfect-scrollbar/perfect-scrollbar.js') }}"></script>
    <script src="{{ asset('assetschat/vendor/libs/hammer/hammer.js') }}"></script>
    <script src="{{ asset('assetschat/vendor/libs/i18n/i18n.js') }}"></script>
    <script src="{{ asset('assetschat/vendor/libs/typeahead-js/typeahead.js') }}"></script>
    <script src="{{ asset('assetschat/vendor/js/menu.js') }}"></script>
    <script src="{{ asset('assetschat/vendor/libs/bootstrap-maxlength/bootstrap-maxlength.js') }}"></script>
    <script src="{{ asset('assetschat/js/main.js') }}"></script>
    <script src="{{ asset('assetschat/js/app-chat.js') }}"></script>
@endsection
